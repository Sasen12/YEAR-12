...
class Settings:
    ...
    def __init__(self):
        ...
        self.JWT_SECRET = os.getenv("JWT_SECRET", "change_me_for_prod_minimum_32_chars")
    ...
    def _validate(self):
        if self.ENV != "dev" and not self.ALLOW_INSECURE_JWT and self.JWT_SECRET == "change_me_for_prod_minimum_32_chars":
